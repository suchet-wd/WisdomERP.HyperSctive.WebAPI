...
namespace HyperActive.Controllers
{
    public class JobController : ApiController
    {
        ...
        // Start GetWaitingJob
        [HttpPost]
        [Route("api/GetWaitingJob/")]
        public HttpResponseMessage GetWaitingJob()
        {
            string _Qry = "";
            string JSONresult = "";
            ...
            _Qry = "EXEC [" + WSM.Conn.DB.DataBaseName.HITECH_HYPERACTIVE + "].dbo.[SP_Send_Data_GetWaitingJob]  ";
            try
            {
        ...
        //        };
        //    }
        //} // End GetBoxInfo API_9 : Pack Results GetPackResultsByPeriod
    }
}
